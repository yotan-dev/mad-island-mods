...
namespace EnhancedIsland.BetterWorkplaces
{
	internal class StoneWork
	{
		public static void GiveRewards(CommonStates common, WorkPlace workPlace, InventorySlot tmpInventory, int posID, NPCManager __instance)
		{
			...
			var itemData = __instance.WorkReward(NPCMove.WorkType.Stone, workPlace, 1);
			...
			{
				itemData = __instance.WorkReward(NPCMove.WorkType.Stone, workPlace, 3);
			...
			{
				itemData = __instance.WorkReward(NPCMove.WorkType.Stone, workPlace, 2);
