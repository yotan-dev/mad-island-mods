...
namespace YotanModCore.DataStore
{
	...
	/// </summary>
	public class SaveGameDataPatch_v0_4_5_6
	{
		/// <summary>
		/// Patches the Loading process to load custom data
		/// </summary>
		/// <param name="__instance"></param>
		[HarmonyPatch(typeof(SaveManager), nameof(SaveManager.Loading))]
		[HarmonyPrefix]
		private static void Pre_SaveManager_Loading(SaveManager __instance)
		{
