...
namespace YotanModCore.Consts
{
	public static class Emote
	{
		...
		public const int IconPartsGengirlOppai = 13; // icon_parts_gengirl_oppai.asset

		public const int Water01 = 14; // water_01.asset

		public const int Punch01 = 15; // punch_01.asset

		public const int IconAttention01 = 16; // icon_attention_01.asset

		public const int UiNameVisible = 17; // ui_name_visible.asset

		public const int IconAttack01 = 18; // icon_attack_01.asset

		public const int UiNameInvisible = 19; // ui_name_invisible.asset
	}
}
