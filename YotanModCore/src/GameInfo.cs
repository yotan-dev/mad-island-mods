	...
	public class GameInfo
	{
		...
		private Version ParseVersion()
		{
			...
			Dictionary<string, Version> buildDateVersion = new Dictionary<string, Version>() {
				...
				{ "2026/02/23--13:23", ToVersion("0.5.8.1") }, // Beta
				{ "2026/02/24--23:47", ToVersion("0.5.8.2") }, // Beta
				{ "2026/04/06--21:33", ToVersion("0.5.9.0") }, // Beta
				{ "2026/04/07--00:29", ToVersion("0.5.9.1") }, // Beta
				{ "2026/05/09--10:49", ToVersion("0.5.10.0")}, // Beta
				{ "2026/05/09--17:25", ToVersion("0.5.10.1")}, // Beta
				{ "2026/05/11--01:29", ToVersion("0.5.10.2")}, // Beta
				{ "2026/06/24--01:27", ToVersion("0.5.11.1")}, // Beta
				{ "2026/06/24--02:20", ToVersion("0.5.11.2")}, // Beta
				{ "2026/06/24--11:05", ToVersion("0.5.11.3")}, // Beta
				{ "2026/06/25--14:38", ToVersion("0.5.11.4")}, // Beta
			};
			...
			Dictionary<string, Version> dateToVersion = new Dictionary<string, Version>() {
				...
				{ "2026/06/24", ToVersion("0.5.11.0")}, // Beta; 0.5.11.0 was a bit before 0.5.11.1, same day
			};
